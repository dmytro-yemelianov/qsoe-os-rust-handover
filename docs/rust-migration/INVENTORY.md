...
| Component issues | 13 | Components with concrete Rust artifacts or RC evidence. |
| Backlog, retirement, and inventory issues | 9 | Remaining candidates, deferred areas, retirement gate, and this inventory. |
...
| Task-manager pure or diagnostic modules | #144, #146, #147, #149, #153 | Candidate backlog. Prefer host-tested modules that avoid direct seL4 invocations, spawn, capability ownership, relocation writes, and loader admission. |
