...
| `libtaskman` | 23 | 3,013 | Best source of host-testable task-manager modules. `tm_procfs` is Rust-default RC; `tm_cpio`, `tm_cred`, `tm_script`, and `tm_sysfs` are Rust opt-in; more candidates are tracked in #144-#153. |
...
| Component issues | 11 | Components with concrete Rust artifacts or RC evidence. |
| Backlog, retirement, and inventory issues | 11 | Remaining candidates, deferred areas, retirement gate, and this inventory. |
...
| Task-manager pure or diagnostic modules | #144-#147, #149, #151, #153 | Candidate backlog. Prefer host-tested modules that avoid direct seL4 invocations, spawn, capability ownership, relocation writes, and loader admission. |
...
1. Use #144-#147, #149, #151, and #153 for remaining small task-manager pilots. Prefer
