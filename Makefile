...
.PHONY: all prepare component-overrides clean nvme nvme-populate virtio fsqrv-image tree \
        ...
        tm-syscfg-evidence tm-syscfg-runtime-smoke tm-sysmap-evidence tm-sysmap-runtime-smoke tm-sysfs-evidence tm-sysfs-runtime-smoke tm-sysfs-rc-smoke tm-sysfs-rc-rollback-smoke tm-pseudodev-evidence tm-pseudodev-runtime-smoke \
