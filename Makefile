...
TM_RUST_PROVIDER_COUNT := $(words $(filter 1,$(QSOE_RUST_TM_CPIO) $(QSOE_RUST_TM_CRED) $(QSOE_RUST_TM_PROCFS) $(QSOE_RUST_TM_PSEUDODEV) $(QSOE_RUST_TM_SCRIPT) $(QSOE_RUST_TM_SYSFS)))
ifneq ($(filter 2 3 4 5 6,$(TM_RUST_PROVIDER_COUNT)),)
...
.PHONY: all prepare component-overrides clean nvme nvme-populate virtio fsqrv-image tree \
        ...
        check-tm-script-model check-tm-sysfs-model \
        slog-readback-smoke \
        ...
        rust-tm-script-provider rust-tm-sysfs-provider rust-tm-pseudodev-provider \
        tm-cpio-evidence tm-cred-evidence tm-procfs-evidence tm-script-evidence \
        tm-sysfs-evidence tm-pseudodev-evidence \
        ...
        container-rust-tm-procfs-provider container-rust-tm-script-provider \
        container-rust-tm-sysfs-provider container-rust-tm-pseudodev-provider \
        container-tm-cpio-evidence container-tm-cred-evidence container-tm-procfs-evidence \
        container-tm-script-evidence container-tm-sysfs-evidence \
